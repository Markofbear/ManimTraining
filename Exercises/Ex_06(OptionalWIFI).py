...
class Ex_06(Scene):
    def construct(Wifi):
        ...
        rectangle1 = Rectangle(width=4, height=3, color=BLACK, **fill)
        rectangle1.rotate(50 * DEGREES)
        rectangle1.shift(UP + RIGHT * 3)

        rectangle2 = Rectangle(width=4, height=3, color=BLACK, **fill)
        rectangle2.rotate(-50 * DEGREES)
        rectangle2.shift(UP + LEFT * 3)
